...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var counters = document.querySelectorAll('.interest__number'),
  ...
  form.addEventListener('submit', function (e) {
    ...
    modalStatusClose.addEventListener('click', function () {
    ...
    postData('telegram-lesson/telegram.php', formData).then(function (res) {
      console.log(res);
      modalStatusText.textContent = message.success;
    }).catch(function () {
      return modalStatusText.textContent = message.failure;
    }).finally(function () {
      clearInputs();
      setTimeout(function () {
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_6__["default"])('.pageup');
});
